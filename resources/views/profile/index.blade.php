...
<div class="space-y-6">
    ...
    <div class="grid gap-6 xl:grid-cols-[1.4fr_1fr]">
        ...
        <section id="account-information" class="space-y-4 rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <div class="flex items-center justify-between gap-4">
                <div>
                    <p class="text-sm uppercase tracking-[0.3em] text-slate-400">Informasi Akun</p>
        ...
        <section id="change-password" class="space-y-6 rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <div>
                <p class="text-sm uppercase tracking-[0.3em] text-slate-400">Keamanan</p>
    ...
    <section class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <p class="text-sm uppercase tracking-[0.3em] text-slate-400">Aktivitas Terbaru</p>
